...
Polish Ministry of Digitalization publishes the baby names statistics. [Data](https://dane.gov.pl/dataset/219) is available from 2000 to 2018. In this blog post I analyze the trends from the last 19 years and try to predict the situation in 2019.
